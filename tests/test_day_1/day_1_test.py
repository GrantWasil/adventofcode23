import pytest
from day_1.day_1 import ensure_valid_num, find_nums_in_line, determine_digits, validate_digits, convert_to_values
...
class TestDay1:
    ...
    def test_find_nums_in_line(self):
        ...
        assert find_nums_in_line('4nineeightseven2') == ['4', 'nine', 'eight', 'seven', '2']
